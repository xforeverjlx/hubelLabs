...
const AWS = require('aws-sdk'); //https://stackoverflow.com/questions/31804186/how-to-use-require-in-web-application-which-is-running-inside-node-js
...
function submit(){
	...
	curData.push(words[count]);
	//also push (append) pinyin & filename
...
function save(){
	...
	console.log(semail);
	console.log(sform);
	// ^ is working, just need to save somewhere

	let userData = [semail, sage, sgender, sdialect, sform];
}
