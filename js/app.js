...
function submit(){
  // var curData = userData;
  // var keyString = curData.join("_");
  keyString = userData;
  keyString = keyString + "_" + words[count] + ".wav";
  ...
  // const ID = "AKIAYOBVSHLIXU7XDYWL";
  const ID = "AKIAYOBVSHLIZUFAIF2Y";
  // const SECRET = "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";
  const SECRET = "A01HIDnj5osztB/qLjNrDag7IhjBHpDDz80PaZ7o";
  // const region = "ap-southeast-1";

  var fileName = blobToFile(finalSoundFile, recordingsList.firstChild.textContent);
...
function save(){
  ...
  userData.push(semail, sage, sgender, sdialect, sform);
  var userDataString = userData.join("_");
